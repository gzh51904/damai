...
<div id="app">
    ...
    <div class="detail-service-info" v-show="msg" style="padding-bottom: 2.916667rem;">
        <h4>服务说明 <span  @click="hide"></span></h4>
        <dl class="info-item">
            <dt class="info-item-no">支持选座</dt>
            <dd>本项目支持选座<br/>1. 选择演出时间，并点击“选座购票”进入选座页面 
...
*先付后选的项目需要先付款，到开放选座的日期我们会短信通知，请注意查收
 快递票</dd>
    ...
    <div class="detail-time-info" @click="show1">
        <div class="left">
            <div class="time">
                <span class="time-str">2019.08.04 周日 19:00</span>
                <i class="j"></i>
            </div>
        ...
        <div class="sku-bottom">
            ...
            <div class="price-button">
                <div class="price-container">
                    <div class="price-top"><span class="price-text">更多信息请前往选座页</span>
...
<!----------- 最底部固定部分----------- -->
    ...
    justify-content:span-around;">
                <div  class="left1"><i  class="left__icon2 icon-home"></i>
                    <p  class="left__msg">大麦首页</p>
                </div>
                <div  class="left1"><i  class="left__icon left__icon-disfavor"></i>
...
.detail-service-info h4 {
    position: relative;
    height: .902778rem;
    line-height: .902778rem;
    text-align: center;
    font-weight: 700;
    border-bottom: .013889rem solid #ccc;
}
