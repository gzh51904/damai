...
<div id="app">
    ...
    <div class="notice">
        ...
        <span class="notice-one">不支持选座</span>
        <span>快递票</span>
        <span>纸质发票</span>
    </div>
    <div class="detail-service-info">
        <h4>服务说明 <span></span></h4>
        <dl class="info-item">
            <dt class="info-item-no">不支持选座</dt>
            <dd>本项目不支持选座，同一个订单优先连坐</dd>
        </dl>
        <dl class="info-item">
            <dt>快递票</dt>
...
.notice .notice-one {
    background: url(img/cha.png) no-repeat left center;
}
